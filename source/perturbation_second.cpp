...
double integrand_z2(double z2, SecondOrderArguments args) {
    ...
    auto [I, err] = GaussKronrod<SecondOrderArguments>(integrand_z1, 0.0, z2, args.rtols[1], args.atols[1], args);
    return I;
}
...
double integrand_theta(double theta, SecondOrderArguments args) {
    ...
    auto [I, err] = GaussKronrod<SecondOrderArguments>(integrand_phi, 0.0, 2.*std::numbers::pi, args.rtols[3], args.atols[3], args);
    return I;
}
